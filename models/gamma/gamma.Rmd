...
par(mfrow=c(1,2))
# Residuals plot
gamma.fitted = fitted(gamma_model)
gamma.devresid = residuals(gamma_model, type="deviance")
#postscript(file="meat-resid.ps", hori=T)
plot(gamma.fitted, gamma.devresid, xlab="Fitted counts", ylab="Deviance residuals", pch=19, col="red", cex=1.5, main="Fitted vs deviance residual plotfor ants per sandwich model")
